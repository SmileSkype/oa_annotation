                ...
                <table cellpadding="0" cellspacing="0" class="mains:form">
                    <tr><td width="100">所属部门</td>
                        ...
                        <!-- 
                        	list 数据的来源
                        	listValue 显示的文本内容
                        	listKey option的属性的value的值
                        	
                         -->
                        <s:select list="#departmentList" headerKey="" headerValue="--请选择--" 
                        	listKey="did" listValue="dname" cssClass="SelectStyle" name="did"></s:select>
					...
					<tr><td>联系电话</td>
                        <td><s:textfield name="phone" cssClass="InputStyle"></s:textfield>
                    </tr>
                    <tr><td>E-mail</td>
                        <td><s:textfield name="email" cssClass="InputStyle"></s:textfield>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mains:form">
                    <tr>
						...
						<!-- 
							list  数据的来源
							listKey  option属性中value的值
							listValue 显示的文本内容
						 -->
						 
                        <td><s:select list="#postList" listKey="pid" listValue="pname" multiple="true"
						 		headerKey="" name="pids" cssClass="SelectStyle"></s:select>
