...
<div class="addnodes" id="rMenu" style="position:absolute;display:none;overflow:hidden">
       <ul>
         <li id="addFile" style="background: url(css/images/jia.jpg) 10px 5px no-repeat;border-bottom:1px solid #8ab2e6;cursor:pointer">增加文件</li>
         <li id="addFolder" style="background: url(css/images/jia.jpg) 10px 5px no-repeat;border-bottom:1px solid #8ab2e6;cursor:pointer">增加文件夹</li>
         <li id="deleteNode" style="background: url(css/images/jian.jpg) 10px 9px no-repeat;border-bottom:1px solid #8ab2e6;cursor:pointer">删除节点</li>
         <li id="updateNode" style="background: url(css/images/MenuIcon/FUNC241000.gif) 10px 9px no-repeat;border-bottom:1px solid #8ab2e6;cursor:pointer">修改节点</li>
       </ul>
    </div>
</BODY>
</HTML>